  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-slate-950 text-white">
      <form onSubmit={handleSubmit} className="w-full max-w-md rounded-3xl border border-white/10 bg-white/5 p-8 shadow-glow">
        <h1 className="text-2xl font-semibold">Welcome to Brainz</h1>
        <p className="mt-2 text-sm text-slate-300">Powered by Neuritas-AI</p>
        <p className="mt-3 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-3 text-xs text-emerald-100">Sign in to access Brainz. Use your Brainz account details to sign in. If you are an administrator, you can manage users from the settings page.</p>
