  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-slate-950 text-white">
      <form onSubmit={handleSubmit} className="w-full max-w-md rounded-3xl border border-white/10 bg-white/5 p-8 shadow-glow">
        ...
        <p className="mt-3 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-3 text-xs text-emerald-100">Use your Neuritas-AI account details to sign in. If you are an administrator, you can manage users from the settings page.</p>
